  ...
  return {
    ...
    plugins: [
      ...
      /*
        ...
        We need to configure some plugins for Webpack to use. They 
      ...
      /*
      For WebpackPwaManifest, we'll need the following values set in the config object:

      fingerprints should be false
      inject should be true
      name should be 'Just Another Text Editor'
      short_name should be 'J.A.T.E'
      description can be anything you like. This is an app that creates a text editor, 
      so write something suitable.
